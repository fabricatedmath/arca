...
__cosf = opify (Op "__cosf" :: Op (OneArg F) F)
...
__exp10f = opify (Op "__exp10f" :: Op (OneArg F) F)
...
__fmaf_ru = opify (Op "__fmaf_ru" :: Op (ThreeArg F F F) F)
...
__log10f = opify (Op "__log10f" :: Op (OneArg F) F)
...
__log2f = opify (Op "__log2f" :: Op (OneArg F) F)
