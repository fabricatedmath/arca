...
__double2float_rd = opify (Op "__double2float_rd" :: Op (OneArg D) (OneArg F))
...
__double2float_rn = opify (Op "__double2float_rn" :: Op (OneArg D) (OneArg F))
...
__double2float_ru = opify (Op "__double2float_ru" :: Op (OneArg D) (OneArg F))
...
__double2float_rz = opify (Op "__double2float_rz" :: Op (OneArg D) (OneArg F))
...
__double2hiint = opify (Op "__double2hiint" :: Op (OneArg D) (OneArg I))
...
__double2int_rd = opify (Op "__double2int_rd" :: Op (OneArg D) (OneArg I))
...
__double2int_rn = opify (Op "__double2int_rn" :: Op (OneArg D) (OneArg I))
...
__double2int_ru = opify (Op "__double2int_ru" :: Op (OneArg D) (OneArg I))
...
__double2int_rz = opify (Op "__double2int_rz" :: Op (OneArg D) (OneArg I))
...
__double2ll_rd = opify (Op "__double2ll_rd" :: Op (OneArg D) (OneArg L))
...
__double2ll_rn = opify (Op "__double2ll_rn" :: Op (OneArg D) (OneArg L))
...
__double2ll_ru = opify (Op "__double2ll_ru" :: Op (OneArg D) (OneArg L))
...
__double2ll_rz = opify (Op "__double2ll_rz" :: Op (OneArg D) (OneArg L))
...
__double2loint = opify (Op "__double2loint" :: Op (OneArg D) (OneArg I))
...
__double2uint_rd = opify (Op "__double2uint_rd" :: Op (OneArg D) (OneArg UI))
...
__double2uint_rn = opify (Op "__double2uint_rn" :: Op (OneArg D) (OneArg UI))
...
__double2uint_ru = opify (Op "__double2uint_ru" :: Op (OneArg D) (OneArg UI))
...
__double2uint_rz = opify (Op "__double2uint_rz" :: Op (OneArg D) (OneArg UI))
...
__double2ull_rd = opify (Op "__double2ull_rd" :: Op (OneArg D) (OneArg UL))
...
__double2ull_rn = opify (Op "__double2ull_rn" :: Op (OneArg D) (OneArg UL))
...
__double2ull_ru = opify (Op "__double2ull_ru" :: Op (OneArg D) (OneArg UL))
...
__double2ull_rz = opify (Op "__double2ull_rz" :: Op (OneArg D) (OneArg UL))
...
__double_as_longlong = opify (Op "__double_as_longlong" :: Op (OneArg D) (OneArg L))
...
__float2int_rd = opify (Op "__float2int_rd" :: Op (OneArg F) (OneArg I))
...
__float2int_rn = opify (Op "__float2int_rn" :: Op (OneArg F) (OneArg I))
...
__float2int_ru = opify (Op "__float2int_ru" :: Op (OneArg F) (OneArg I))
...
__float2int_rz = opify (Op "__float2int_rz" :: Op (OneArg F) (OneArg I))
...
__float2ll_rd = opify (Op "__float2ll_rd" :: Op (OneArg F) (OneArg L))
...
__float2ll_rn = opify (Op "__float2ll_rn" :: Op (OneArg F) (OneArg L))
...
__float2ll_ru = opify (Op "__float2ll_ru" :: Op (OneArg F) (OneArg L))
...
__float2ll_rz = opify (Op "__float2ll_rz" :: Op (OneArg F) (OneArg L))
...
__float2uint_rd = opify (Op "__float2uint_rd" :: Op (OneArg F) (OneArg UI))
...
__float2uint_rn = opify (Op "__float2uint_rn" :: Op (OneArg F) (OneArg UI))
...
__float2uint_ru = opify (Op "__float2uint_ru" :: Op (OneArg F) (OneArg UI))
...
__float2uint_rz = opify (Op "__float2uint_rz" :: Op (OneArg F) (OneArg UI))
...
__float2ull_rd = opify (Op "__float2ull_rd" :: Op (OneArg F) (OneArg UL))
...
__float2ull_rn = opify (Op "__float2ull_rn" :: Op (OneArg F) (OneArg UL))
...
__float2ull_ru = opify (Op "__float2ull_ru" :: Op (OneArg F) (OneArg UL))
...
__float2ull_rz = opify (Op "__float2ull_rz" :: Op (OneArg F) (OneArg UL))
...
__float_as_int = opify (Op "__float_as_int" :: Op (OneArg F) (OneArg I))
...
__float_as_uint = opify (Op "__float_as_uint" :: Op (OneArg F) (OneArg UI))
...
__hiloint2double = opify (Op "__hiloint2double" :: Op (TwoArg I I) (OneArg D))

-- | Convert a signed int to a double.
__int2double_rn :: (HasIdentifier w, HasStackLens w D, HasStackLens w I) => PartialStackOp w
__int2double_rn = opify (Op "__int2double_rn" :: Op (OneArg I) (OneArg D))
...
__int2float_rd = opify (Op "__int2float_rd" :: Op (OneArg I) (OneArg F))
...
__int2float_rn = opify (Op "__int2float_rn" :: Op (OneArg I) (OneArg F))
...
__int2float_ru = opify (Op "__int2float_ru" :: Op (OneArg I) (OneArg F))
...
__int2float_rz = opify (Op "__int2float_rz" :: Op (OneArg I) (OneArg F))
...
__int_as_float = opify (Op "__int_as_float" :: Op (OneArg I) (OneArg F))
...
__ll2double_rd = opify (Op "__ll2double_rd" :: Op (OneArg L) (OneArg D))
...
__ll2double_rn = opify (Op "__ll2double_rn" :: Op (OneArg L) (OneArg D))
...
__ll2double_ru = opify (Op "__ll2double_ru" :: Op (OneArg L) (OneArg D))
...
__ll2double_rz = opify (Op "__ll2double_rz" :: Op (OneArg L) (OneArg D))

-- | Convert a signed integer to a float in round-down mode.
__ll2float_rd :: (HasIdentifier w, HasStackLens w F, HasStackLens w L) => PartialStackOp w
__ll2float_rd = opify (Op "__ll2float_rd" :: Op (OneArg L) (OneArg F))
...
__ll2float_rn = opify (Op "__ll2float_rn" :: Op (OneArg L) (OneArg F))

-- | Convert a signed integer to a float in round-up mode.
__ll2float_ru :: (HasIdentifier w, HasStackLens w F, HasStackLens w L) => PartialStackOp w
__ll2float_ru = opify (Op "__ll2float_ru" :: Op (OneArg L) (OneArg F))

-- | Convert a signed integer to a float in round-towards-zero mode.
__ll2float_rz :: (HasIdentifier w, HasStackLens w F, HasStackLens w L) => PartialStackOp w
__ll2float_rz = opify (Op "__ll2float_rz" :: Op (OneArg L) (OneArg F))
...
__longlong_as_double = opify (Op "__longlong_as_double" :: Op (OneArg L) (OneArg D))

-- | Convert an unsigned int to a double.
__uint2double_rn :: (HasIdentifier w, HasStackLens w D, HasStackLens w UI) => PartialStackOp w
__uint2double_rn = opify (Op "__uint2double_rn" :: Op (OneArg UI) (OneArg D))
...
__uint2float_rd = opify (Op "__uint2float_rd" :: Op (OneArg UI) (OneArg F))
...
__uint2float_rn = opify (Op "__uint2float_rn" :: Op (OneArg UI) (OneArg F))
...
__uint2float_ru = opify (Op "__uint2float_ru" :: Op (OneArg UI) (OneArg F))
...
__uint2float_rz = opify (Op "__uint2float_rz" :: Op (OneArg UI) (OneArg F))
...
__uint_as_float = opify (Op "__uint_as_float" :: Op (OneArg UI) (OneArg F))
...
__ull2double_rd = opify (Op "__ull2double_rd" :: Op (OneArg UL) (OneArg D))
...
__ull2double_rn = opify (Op "__ull2double_rn" :: Op (OneArg UL) (OneArg D))
...
__ull2double_ru = opify (Op "__ull2double_ru" :: Op (OneArg UL) (OneArg D))
