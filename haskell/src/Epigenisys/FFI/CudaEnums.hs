...
module Epigenisys.FFI.CudaEnums (NvrtcResult(..), CUResult(..), cuResultIntToCode) where
...
data NvrtcResult = 
    ...
    | NVRTC_ERROR_INTERNAL_ERROR
        ...
        deriving TextShow via FromGeneric NvrtcResult

cuResultIntToCode :: Int -> CUResult
cuResultIntToCode = (cuResultMap IntMap.!)

-- | Auto-Generated from Html Cuda documentation
...
data CUResult = 
    ...
    | CUDA_ERROR_UNKNOWN
        ...
        deriving TextShow via FromGeneric CUResult